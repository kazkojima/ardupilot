...
#ifndef AP_COMPASS_HACHIDORI_ENABLED
#define AP_COMPASS_HACHIDORI_ENABLED (AP_COMPASS_BACKEND_DEFAULT_ENABLED && CONFIG_HAL_BOARD == HAL_BOARD_LINUX && CONFIG_HAL_BOARD_SUBTYPE == HAL_BOARD_SUBTYPE_LINUX_HACHIDORI)
#endif
